...
#
print('Column values of the dataset:')
...
# shape is 350 rows * 1738 cols, here 1738 represents the total number of unique words in all the comments
...
# 5275 is the total number of times a word is found exist in the comment
...
# labeling the data as spam and non-spam
