...
class Park(Environment):
    ...
    def execute_action(self, agent, action):
        ...
        # +++ Requirement 4a +++
            ...
            if len(items) != 0:
                if agent.bark(items[0]): #Have the dog bark to the person
    ...
    def is_done(self):
        ...
        # +++ Requirement 4b +++
        no_people = not any(isinstance(thing, Person) for thing in self.things)
        return dead_agents or (no_edibles and no_people)
    #########
...
# +++ Requirement 1 +++
newDogFood = Food()
park.add_thing(newDogFood, 9)

# +++ Requirement 3 +++
Matheus = Person()
park.add_thing(Matheus, 3)
